      ...
      <div className="timeline-page">
        ...
        <div className="month-selector">
          ...
          <div className="month-info">
            ...
            <p className="month-balance">
              Solde du mois: <span className={monthBalance >= 0 ? "positive" : "negative"}>
        ...
        <div className="totals-summary">
          ...
          <div className="total-card expense">
            ...
            <span className="total-amount">{formatAmount(totals.expense)}</span>
          </div>
                          ...
                          <div className="transaction-main">
                            ...
                            {transaction.recurrence_frequency && (
                              <span className="badge badge-recurring">
                                {RECURRENCE_FREQUENCY_LABELS[transaction.recurrence_frequency]}
                              </span>
                            )}
                          </div>
